...
def lease_car():
  ...
  if user[0][1] ==  username:
    ...
    try:
      ...
      cur.execute("insert into lease(id_car, id_driver, start_of_lease, end_of_lease, status, note) values (%s, %s, %s, %s, %s, %s)", (car_data[0][0], user[0][0], timeof, timeto, True, note,))
