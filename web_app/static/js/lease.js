...
function renderDetails(car_details) {
  ...
  if (role === 'manager'){
    const container = document.getElementById('car-details-right');

    // Create label
    const label = document.createElement('label');
    label.setAttribute('for', 'car-decom-button');
    label.textContent = 'Odstaviť auto';

    // Create button
    const button = document.createElement('input');
    button.setAttribute('id', 'car-decom-button');
